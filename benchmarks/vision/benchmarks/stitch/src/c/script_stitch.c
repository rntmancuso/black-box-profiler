...
void symbol_stitch(I2D *Icur,F2D *v,F2D *int1, F2D *int2, F2D* interestPnts,F2D** Fcur_ptr)
{
  int i;
  v = harris(Icur);
    ...
    *Fcur_ptr = extractFeatures(Icur, int1, int2);  
}
...
int main(int argc, char* argv[])
{
    ...
    symbol_stitch(Icur,v,int1,int2,interestPnts,&Fcur);
